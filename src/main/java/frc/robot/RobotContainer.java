...
public class RobotContainer {
        ...
        public Joystick m_rightDriverController = new Joystick(OIConstants.kRightDriverControllerPort);
        ...
        private void configureButtonBindings() {
                ...
                /*
                 * new JoystickButton(m_rightDriverController, OIConstants.kJS_Trigger)
                 * .whileTrue(new DriveWithAprilTagCommand(m_robotDrive, m_limelight,
                 * m_leftDriverController))
                 * .onFalse(new InstantCommand(() ->
                 * m_robotDrive.resetLimelightOffset(),m_limelight));
                 */
         ...
         * Look at switch statements for defining lists of things (buttons, autons,
         * setpoints, etc.)
         * Program autons DONE
         * Autons with pathweaver DONE
         * Design a new drivestation that fits this laptop and the joysticks IN PROGRESS
         * (depending on drake)
         * 
         * General Notes:
         * I think we're using commands for too simple of tasks. I think we can handle
         * individual things
         * (toggling states of things especially) with instant commands instead. I think
         * the commands should be used when
         * we're grouping things together to keep the buik of the logic out of this file
         * and in the command files.
         * Also learned that our smart dashboard calls should go in the periodic section
         * of the subsystem. i agree
         */
