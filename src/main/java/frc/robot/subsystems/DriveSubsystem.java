...
public class DriveSubsystem extends SubsystemBase {
  ...
  private ChassisSpeeds limelightOffset;
  ...
  public DriveSubsystem() {
    ...
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController( // PPHolonomicController is the built in path following controller for holonomic
                                        // drive trains
            new PIDConstants(ModuleConstants.kDrivingP, ModuleConstants.kDrivingI, ModuleConstants.kDrivingD), // Translation
                                                                                                               // PID
                                                                                                               // constants
            new PIDConstants(ModuleConstants.kTurningP, ModuleConstants.kTurningI, ModuleConstants.kTurningD) // Rotation
                                                                                                              // PID
                                                                                                              // constants
        ),
    ...
    resetLimelightOffset();
  }

  /**
   * Reset the limelightOffset to zero all zero values
   */
  public void resetLimelightOffset() {
    limelightOffset = new ChassisSpeeds(0, 0, 0);
  }
  ...
  public void updateLimelightOffset() {
    ...
    limelightOffset = new ChassisSpeeds(tChassisSpeeds.vxMetersPerSecond * DriveConstants.kMaxSpeedMetersPerSecond,
        ...
        tChassisSpeeds.omegaRadiansPerSecond * DriveConstants.kMaxAngularSpeed);
  }
